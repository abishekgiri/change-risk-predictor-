...
async def github_webhook(
 ...
 f"### Violations\n"
 + ("\n".join(f"- {r}" for r in score_data.get("reasons", [])) if score_data["reasons"] else "_No policy violations found._")
 )
 ...
 conclusion = "failure" if run_result.overall_status == "BLOCK" else "success" # WARN is success? or neutral? GitHub only has success/failure/neutral/cancelled...
